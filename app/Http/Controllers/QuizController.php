...
//                 Log::error(
//                     "Failed to create score or update ranking: " . $scoreException->getMessage(),
//                 );
//             }
...
//                         "errors" => [
//                             "slug" => [
//                                 "Ce titre de quiz existe déjà, veuillez en choisir un autre.",
//                             ],
//                         ],
//                     ],
//                     422,
...
//     {
//         $quiz = Quiz::with(["tags", "level", "category", "user", "questions.answers"])->find($id);
